...
const (
	...
	PPC_INS_DCBZ_L = C.PPC_INS_DCBZ_L
	PPC_INS_PSQ_L = C.PPC_INS_PSQ_L
	PPC_INS_PSQ_LU = C.PPC_INS_PSQ_LU
	PPC_INS_PSQ_LUX = C.PPC_INS_PSQ_LUX
	PPC_INS_PSQ_LX = C.PPC_INS_PSQ_LX
	PPC_INS_PSQ_ST = C.PPC_INS_PSQ_ST
	PPC_INS_PSQ_STU = C.PPC_INS_PSQ_STU
	PPC_INS_PSQ_STUX = C.PPC_INS_PSQ_STUX
	PPC_INS_PSQ_STX = C.PPC_INS_PSQ_STX
	PPC_INS_PS_ABS = C.PPC_INS_PS_ABS
	PPC_INS_PS_ADD = C.PPC_INS_PS_ADD
	PPC_INS_PS_CMPO0 = C.PPC_INS_PS_CMPO0
	PPC_INS_PS_CMPO1 = C.PPC_INS_PS_CMPO1
	PPC_INS_PS_CMPU0 = C.PPC_INS_PS_CMPU0
	PPC_INS_PS_CMPU1 = C.PPC_INS_PS_CMPU1
	PPC_INS_PS_DIV = C.PPC_INS_PS_DIV
	PPC_INS_PS_MADD = C.PPC_INS_PS_MADD
	PPC_INS_PS_MADDS0 = C.PPC_INS_PS_MADDS0
	PPC_INS_PS_MADDS1 = C.PPC_INS_PS_MADDS1
	PPC_INS_PS_MERGE00 = C.PPC_INS_PS_MERGE00
	PPC_INS_PS_MERGE01 = C.PPC_INS_PS_MERGE01
	PPC_INS_PS_MERGE10 = C.PPC_INS_PS_MERGE10
	PPC_INS_PS_MERGE11 = C.PPC_INS_PS_MERGE11
	PPC_INS_PS_MR = C.PPC_INS_PS_MR
	PPC_INS_PS_MSUB = C.PPC_INS_PS_MSUB
	PPC_INS_PS_MUL = C.PPC_INS_PS_MUL
	PPC_INS_PS_MULS0 = C.PPC_INS_PS_MULS0
	PPC_INS_PS_MULS1 = C.PPC_INS_PS_MULS1
	PPC_INS_PS_NABS = C.PPC_INS_PS_NABS
	PPC_INS_PS_NEG = C.PPC_INS_PS_NEG
	PPC_INS_PS_NMADD = C.PPC_INS_PS_NMADD
	PPC_INS_PS_NMSUB = C.PPC_INS_PS_NMSUB
	PPC_INS_PS_RES = C.PPC_INS_PS_RES
	PPC_INS_PS_RSQRTE = C.PPC_INS_PS_RSQRTE
	PPC_INS_PS_SEL = C.PPC_INS_PS_SEL
	PPC_INS_PS_SUB = C.PPC_INS_PS_SUB
	PPC_INS_PS_SUM0 = C.PPC_INS_PS_SUM0
	PPC_INS_PS_SUM1 = C.PPC_INS_PS_SUM1
